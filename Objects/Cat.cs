...
namespace IIS.sadasda1213fff
{
    ...
    [View("CatL", new string[] {
            "CatName as \'Cat name\'",
            "Weight as \'Weight\'"})]
    public class Cat : IIS.sadasda1213fff.Animal
    {
        
        private string fCatName;
        
        private IIS.sadasda1213fff.DetailArrayOfPaws fPaws;
        ...
        public virtual IIS.sadasda1213fff.DetailArrayOfPaws Paws
        {
            get
            {
                ...
                if ((this.fPaws == null))
                {
                    this.fPaws = new IIS.sadasda1213fff.DetailArrayOfPaws(this);
                }
                IIS.sadasda1213fff.DetailArrayOfPaws result = this.fPaws;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View CatE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("CatE", typeof(IIS.sadasda1213fff.Cat));
                }
            }
            ...
            public static ICSSoft.STORMNET.View CatL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("CatL", typeof(IIS.sadasda1213fff.Cat));
                }
            }
        }
    }
